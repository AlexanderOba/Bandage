...
const Header = () => {
    return (
        <div>
            <div className="bg-[#23856D] px-10 py-5 flex items-center justify-between">
            ...
            <div className="flex px-10 py-5 items-center justify-between">
                <div className="flex items-center w-[59%]">
                    <div className="text-[#252B42] text-[24px] font-[700] mr-9 w-[20%]">
                        Bandage
                    </div>
                ...
                <div className="flex text-[#23A6F0] text-[14px] font-bold w-[23%]">
